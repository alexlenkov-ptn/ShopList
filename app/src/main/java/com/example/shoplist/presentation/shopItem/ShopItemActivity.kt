...
class ShopItemActivity : AppCompatActivity(), ShopItemFragment.onEditingFinished {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        Log.d("ShopItemActivity", "Fragment created")
    ...
    private fun launchRightMode() {
        val fragment = when (screenMode) {
            MODE_EDIT -> ShopItemFragment.newInstanceEditShopItemFragment(shopItemId)
            MODE_ADD -> ShopItemFragment.newInstanceAddShopItemFragment()
